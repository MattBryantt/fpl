...
def build_parser() -> argparse.ArgumentParser:
    ...
    def add_common(sub):
        ...
        sub.add_argument("--last-season", type=float, default=0.25, metavar="W",
                         help="how much last season's evidence counts once this "
                              "season is under way, 0-1 (default 0.25; 1 = a minute "
    ...
    snap.add_argument("--last-season", type=float, default=0.25, metavar="W",
